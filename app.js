...
async function getUsers() {
  ...
  for (user of data) {
    ...
    <div class="card-header bg-transparent border-primary"> <i class="bi bi-person-vcard"></i> ${user.name}<p id="bosluk"><i class="bi bi-fingerprint"></i> ${user.username}</p><i class="bi bi-telephone"></i> ${user.phone}<p id="bosluk"><i class="bi bi-envelope-at-fill"></i> ${user.email}</p><i class="bi bi-globe"></i> ${user.website}</div>
